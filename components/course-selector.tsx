...
export function CourseSearchResults({
  ...
  return (
    <TableContainer
      component={Paper}
      sx={{ width: "75%", margin: "auto", minHeight: "300px" }}
    >
      <Table sx={{ minWidth: 650 }} aria-label="simple table">
        <TableHead>
          <TableRow>
            ...
            <TableCell
              sx={{ maxHeight: "100px", overflowY: "auto", display: "block" }}
            >
              <b>Description</b>
            </TableCell>
          </TableRow>
              ...
              >
                ...
                <TableCell sx={{ whiteSpace: "nowrap" }}>
                  {result.schedules.start_time
                    ? new Date(
                        `1970-01-01T${result.schedules.start_time}`,
                      ).toLocaleTimeString([], {
                        hour: "2-digit",
                        minute: "2-digit",
                      })
                  ...
                  {result.schedules.end_time
                    ? new Date(
                        `1970-01-01T${result.schedules.end_time}`,
                      ).toLocaleTimeString([], {
                        hour: "2-digit",
                        minute: "2-digit",
                      })
                ...
                <TableCell sx={{ whiteSpace: "nowrap" }}>
                  {result.schedules.start_date
                    ? new Date(result.schedules.start_date).toLocaleDateString(
                        [],
                  ...
                  {result.schedules.end_date
                    ? new Date(result.schedules.end_date).toLocaleDateString(
                        [],
                        { month: "short", day: "numeric" },
                      )
                    : result.schedules.start_date
